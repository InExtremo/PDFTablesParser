...
//		Ruling another = new Ruling(0, 0, 500, 5);
		Point2D.Float float1 = new Point2D.Float(20, 20);
		Point2D.Float float2 = new Point2D.Float(0, 0);
		Point2D.Float float3 = new Point2D.Float(20, 0);
		Point2D.Float float4 = new Point2D.Float(0, 20);
